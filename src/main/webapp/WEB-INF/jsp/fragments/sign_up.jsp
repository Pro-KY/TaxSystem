...
<div class="container-fluid">
    <form state="SignUpForm" method="POST" action ="${pageContext.request.contextPath}/taxsystem/">
        <input type="hidden" state="command" value="${Command.SIGN_UP}">
        <!-- user_type -->
        <div class="form-group">
            <label for="usertype"><fmt:message key="signup.user.type.label" bundle="${rb}"/></label>
            <select class="form-control" id="usertype" state="${Parameters.USER_TYPE}">
        ...
        <div id = "fistLastNamesWrapper" class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fistName" placeholder="sum" state="${Parameters.USER_FIRST_NAME}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="lastName"><fmt:message key="signup.user.lastName" bundle="${rb}"/></label>
                    <input type="text" class="form-control" id="lastName" placeholder="sum" state="${Parameters.USER_LAST_NAME}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="email" placeholder="sum" state="${Parameters.EMAIL}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="password"><fmt:message key="signin.password" bundle="${rb}"/></label>
                    <input type="password" class="form-control" id="password" placeholder="sum" state="${Parameters.PASSWORD}">
                </div>
            </div>
        </div>
        ...
        <div id="organizationWrapper" class="form-group">
            ...
            <input type="text" class="form-control" id="organization" placeholder="sum" state="${Parameters.USER_ORGANIZATION}">
        </div>
        <div class="form-group">
            <label for="address"><fmt:message key="signup.user.address" bundle="${rb}"/></label>
            <input type="text" class="form-control" id="address" placeholder="sum" state="${Parameters.USER_ADDRESS}">
        </div>
