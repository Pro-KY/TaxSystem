...
<div class="col-md-3">
    <div class="list-group" id="list-tab" type="tablist">
        ...
        <a class="list-group-item list-group-item-action ${sideBarIndex eq 1 ? 'active' : ''}"
           href="${pageContext.request.contextPath}/taxsystem/?command=${Command.HANDLED_REPORTS}&${Parameters.SIDEBAR_ACTIVE_INDEX}=1&${Parameters.INSPECTOR_ID}=${sessionScope.user.id}" type="tab" >
