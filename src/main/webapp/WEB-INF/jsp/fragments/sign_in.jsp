...
<body>
    ...
    <div><fmt:message key="msg.signup" bundle="${rb}"/> <a href="${pageContext.request.contextPath}/taxsystem/?command=${Command.SIGN_IN}"><fmt:message key="signup" bundle="${rb}"/></a></div>
</body>
</html>
